...
//Sound::Sound(InternalEngine* engine, SoundBuffer* buffer, bool isAutoDelete)
//    : m_currentTime(0)
//    , m_saveCurrentTime(0)
//    , m_isLoop(false)
//    , m_volume(100)
...
//Sound::Sound(InternalBuffer* buffer, bool isAutoDelete)
//        : m_currentTime(0)
//        , m_saveCurrentTime(0)
//        , m_isLoop(false)
//        , m_volume(100)
...
//
//    //m_engine->OnSourceDelete(m_buffer, this);
//    
//    //1. 'locked' variable
